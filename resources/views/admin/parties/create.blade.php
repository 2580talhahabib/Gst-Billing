          ...
          @endforeach
                ...
                <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="account_holder_name" placeholder="Enter Holder Name" name="account_holder_name">
                      <p></p>
                    </div>
                  </div>
                  {{-- account number  --}}
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="branch_address" placeholder="Enter Address" name="branch_address">
                      <p></p>
                    </div>
                  </div>
              </div>
...
window.location.href="{{ route('parties.index') }}?status=success&message=Parties added successfully"
}else{
