                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title   ">Search Gst Bills </h3> <br>
                                <form action="">
                                    <div class="container ">
                                        <div class="search-container d-flex">
                                            ...
                                            <div class="parites_type m-3">
                                                <h5 class="text-muted">Parties Type</h5>
                                                <input type="text" value="{{ Request::get('parties') }}" name="parties"
                                                    class="border border-3 rounded-lg border-muted ">
                                            </div>
                                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($record as $records)
                                            ...
                                            <tr>
                                                ...
                                                <td class="d-flex">
                                                    <a href="{{ route('bills.show', $records->id) }}"
                                                        class="btn btn-info m-1"><i class="fas fa-eye"></i>
                                                    </a>
                                                    <a href="{{ route('bills.edit', $records->id) }}"
                                                        class="btn btn-info m-1"><i class="fas fa-pencil-alt"></i></a>
                                                    <a data-id={{ $records->id }} class="btn btn-danger m-1 deleted"><i
                    ...
                    success: function(response) {
                        if (response.status == true) {
                            window.location.href =
                                "{{ route('bills.index') }}?status=success&message=Bill deleted successfully"
                        } else {
                            window.location.href =
                                "{{ route('bills.index') }}?status=danger&message=Bill did not found"
                        }
                    }
                })
