        ...
        <div class="col-md-12">
          ...
          <div class="card card-info">
            <div class="card-header">
              <h3 class="card-title">Update Bills</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form class="form-horizontal" id="formsubmit">
              ...
              <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input name="invoice_date" value="{{ $edit->invoice_date }}"  type="date" class="form-control" id="invoice_date"  >
                      <p></p>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" value="{{ $edit->invoice_no }}" class="form-control" id="invoice_no"  name="invoice_no">
                      <p></p>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      {{-- <textarea type="text" class="form-control" id="inputEmail3"  name="item_desc"> --}}
                        ...
                        placeholder="Enter your description here...">{{ ($edit->item_desc) ?  $edit->declaration : '' }}</textarea>
                      <p></p>
                    </div>
                  </div>
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="number" value="{{ $edit->total_amount }}" class="form-control" id="total_amount"  name="total_amount">
                      <p></p>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="number" value="{{ $edit->cgst_rate }}" class="form-control" id="cgst_rate"  name="cgst_rate">
                      <p></p>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="number" value="{{ $edit->sgst_rate }}" class="form-control" id="sgst_rate"  name="sgst_rate">
                      <p></p>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="number" value="{{ $edit->igst_rate }}" class="form-control" id="igst_rate"  name="igst_rate">
                      <p></p>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="number" value="{{ $edit->cgst_amount }}" class="form-control" id="cgst_amount"  name="cgst_amount">
                      <p></p>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="number" value="{{ $edit->sgst_amount }}" class="form-control" id="sgst_amount"  name="sgst_amount">
                      <p></p>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="number" value="{{ $edit->igst_amount }}" class="form-control" id="igst_amount"  name="igst_amount">
                      <p></p>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="number" value="{{ $edit->tax_amount }}" class="form-control" id="tax_amount"  name="tax_amount">
                      <p></p>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="number" value="{{ $edit->net_amount }}" class="form-control" id="net_amount"  name="net_amount">
                      <p></p>
                    </div>
                  </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                    ...
                    cols="80"
                     class="w-full p-3 rounded-lg shadow-md border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all outline-none resize-none"
                    placeholder="Enter your description here...">{{ ($edit->declaration) ?  $edit->declaration : '' }}</textarea>
                  <p></p>
                </div>
              </div>
...
<script>
 ...
 e.preventDefault();
 $.ajax({
   url:"{{ route('bills.update',$edit->id) }}",
   type:'put',
   datatype:'json',
...
if(error){
  ...
  for (const field in error) {
   ...
   window.location.href="{{ route('bills.index') }}?status=success&message=Bill Updated Successfully";
}
}
 })
    })
